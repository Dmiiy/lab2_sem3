...
class SortingApp : public QMainWindow {
//Q_OBJECT

public:
    SortingApp(QWidget *parent = nullptr) : QMainWindow(parent) {
        ...
        connect(runButton, &QPushButton::clicked, this, &SortingApp::runSortingTests);
...
int main(int argc, char *argv[]) {
    ...
    SortingApp window;
    window.setWindowTitle("Сравнение скорости сортировок");
